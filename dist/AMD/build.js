...
define("Matrix", ["require", "exports", "Vector"], function (require, exports, Vector_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SMatrix4 = exports.SMatrix3 = exports.SMatrix2 = exports.SquareMatrix = exports.Matrix = void 0;
    ...
    class Matrix {
        ...
        getVector(x) {
            ...
            let out = new Vector_js_1.Vector(this.rows);
    ...
    class SMatrix2 {
         ...
         */
        getIVector() {
            return new Vector_js_1.Vector2(this.a, this.c);
        }
        /**
        * @returns {Vector2} J vector in matrix
        */
        getJVector() {
            return new Vector_js_1.Vector2(this.b, this.d);
        }
        /**
       * Converts matrix to Array
       * @returns {Array<number>} Array
       ...
       */
        toVectorArray() {
            return [new Vector_js_1.Vector2(this.a, this.c), new Vector_js_1.Vector2(this.b, this.d)];
        }
        /**
         ...
         */
        multiplyVector(vector) {
            return new Vector_js_1.Vector2((vector.x * this.a) + (vector.y * this.b), (vector.x * this.c) + (vector.y * this.d));
        }
        /**
         * Multiplies this*matrix
    ...
    class SMatrix3 {
         ...
         */
        getIVector() {
            return new Vector_js_1.Vector3(this.a, this.d, this.g);
        }
        /**
        * @returns {Vector3} j vector in matrix
        */
        getJVector() {
            return new Vector_js_1.Vector3(this.b, this.e, this.h);
        }
        /**
       * @returns {Vector3} k vector in matrix
       */
        getKVector() {
            return new Vector_js_1.Vector3(this.c, this.f, this.i);
        }
        /**
       * Converts matrix to Array
       * @returns {Array<number>} Array
       ...
       */
        toVectorArray() {
            return [new Vector_js_1.Vector3(this.a, this.d, this.g), new Vector_js_1.Vector3(this.b, this.e, this.h), new Vector_js_1.Vector3(this.c, this.f, this.i)];
        }
        /**
         * Multiplies matrix*vector
         * @param {Vector2} vector Vector to multiply by
         ...
         */
        multiplyVector(vector) {
            return new Vector_js_1.Vector3((vector.x * this.a) + (vector.y * this.b) + (vector.z * this.c), (vector.x * this.d) + (vector.y * this.e) + (vector.z * this.f), (vector.x * this.g) + (vector.y * this.h) + (vector.z * this.i));
        }
        /**
         * Multiplies this*matrix
    ...
    class SMatrix4 {
         ...
         */
        getIVector() {
            return new Vector_js_1.Vector4(this.a, this.e, this.i, this.m);
        }
        /**
        * @returns {Vector4} j vector in matrix
        */
        getJVector() {
            return new Vector_js_1.Vector4(this.b, this.f, this.j, this.n);
        }
        /**
       * @returns {Vector4} k vector in matrix
       */
        getKVector() {
            return new Vector_js_1.Vector4(this.c, this.g, this.k, this.o);
        }
        /**
     * @returns {Vector4} l vector in matrix
     */
        getLVector() {
            return new Vector_js_1.Vector4(this.d, this.h, this.l, this.p);
        }
        /**
       * Converts matrix to Array
       * @returns {Array<number>} Array
       ...
       */
         ...
         */
        multiplyVector(vector) {
            return new Vector_js_1.Vector4((vector.x * this.a) + (vector.y * this.b) + (vector.z * this.c) + (vector.w * this.d), (vector.x * this.e) + (vector.y * this.f) + (vector.z * this.g) + (vector.w * this.h), (vector.x * this.i) + (vector.y * this.j) + (vector.z * this.k) + (vector.w * this.l), (vector.x * this.m) + (vector.y * this.n) + (vector.z * this.o) + (vector.w * this.p));
        }
        /**
         * Multiplies this*matrix
